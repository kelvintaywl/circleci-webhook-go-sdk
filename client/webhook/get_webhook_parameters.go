...
// WithID adds the id to the get webhook params
func (o *GetWebhookParams) WithID(id strfmt.UUID) *GetWebhookParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get webhook params
func (o *GetWebhookParams) SetID(id strfmt.UUID) {
	o.ID = id
}
