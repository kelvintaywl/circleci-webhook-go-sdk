...
func (m *WebhooksInfo) validateItems(formats strfmt.Registry) error {
...
func (m *WebhooksInfo) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
